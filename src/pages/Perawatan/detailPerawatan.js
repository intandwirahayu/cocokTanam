...
export default class DetailPerawatan extends Component {
        ...
        try{
            ...
            .then(snapshot => {
                ...
                if(valueField.includes(keyData)){
                    ...
                    this.setState({
                        titleButton: 'Rencanakan Perawatan'
                    })
                }
            })
            .catch(() => {
    ...
    addRencana = async (keyField, idUser, keyData) => {
        try{
            ...
            .then(() => {
                Alert.alert('Berhasil', 'Rencana perawatan berhasil dibuat');
                this.setState({
                    titleButton: 'Sudah Direncanakan'
                });
            })
    ...
    checkSimpanan = async () => {
        try{
            ...
            .then(snapshot => {
                let valueField = Object.values(snapshot.data()); 
                if(valueField.includes(keyData)){
                    Alert.alert('UPS!', 'Tidak dapat disimpan karena sudah dijadikan rencana perawatan');
                }else{
        ...
        try{
            ...
            .then(snapshot => {
                ...
                if(valueField.includes(keyData)){
                    ...
                    .then(() => {
                        Alert.alert('Berhasil', 'Simpanan perawatan berhasil ditambahkan');
                    })
                }
            })
        }catch(e){
                    ...
                    <View style={styles.containerContent}>
                        ...
                        <View style={styles.containerSpecification}>
                            ...
                            <View style={styles.itemSpecification2}>
                                <ItemSpecification title="durasi waktu" value={data_perawatan.durasi_waktu}/>
                            </View>
                        </View>
